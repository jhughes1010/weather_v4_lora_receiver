...
//jh remove//const char* ssid     = "Provence";     // WiFi SSID to connect to
//const char* password = "20hughes20"; // WiFi password needed for the SSID




// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "e3a3454ff160db4c6d9b738de159c7a6";                      // See: https://openweathermap.org/  // It's free to get an API key, but don't take more than 60 readings/minute!
...
String City             = "Cañon City";                      // Your home city See: http://bulk.openweathermap.org/sample/
...
//int   gmtOffset_sec     = -7;    // UK normal time is GMT, so GMT Offset is 0, for US (-5Hrs) is typically -18000, AU is typically (+8hrs) 28800
